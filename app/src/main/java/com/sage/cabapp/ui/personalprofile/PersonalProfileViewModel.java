 ...
 */
public class PersonalProfileViewModel extends BaseViewModel<PersonalProfileNavigator> {
    public PersonalProfileViewModel(SchedulerProvider schedulerProvider) {
    ...
    void getAllPaymentsCardWS(Context context) {
        ...
        getAllPaymentsCardRequestData.setRequestType("activePaymentAll");
