...
import com.sage.cabapp.databinding.ActivityLocationOnMapBinding;
 ...
 */
public class LocationOnMapActivity extends BaseActivity<ActivityLocationOnMapBinding, LocationOnMapViewModel> implements LocationOnMapNavigator, OnMapReadyCallback, TouchableFrameLayout.OnChangeListener {

    @Inject
    ViewModelProviderFactory factory;
    private LocationOnMapViewModel locationOnMapViewModel;
    private ActivityLocationOnMapBinding activityLocationOnMapBinding;
    ...
    public void onInteractionEnd() {
        if (activityLocationOnMapBinding.navigationIcon.getVisibility() == View.GONE)
            activityLocationOnMapBinding.navigationIcon.setVisibility(View.VISIBLE);
    }
    ...
    @Override
    public LocationOnMapViewModel getViewModel() {
        locationOnMapViewModel = ViewModelProviders.of(this, factory).get(LocationOnMapViewModel.class);
        return locationOnMapViewModel;
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        activityLocationOnMapBinding = getViewDataBinding();
        locationOnMapViewModel.setNavigator(this);
                    ...
                    switch (statusCode) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                rae.startResolutionForResult(LocationOnMapActivity.this, REQUEST_CHECK_SETTINGS);
            ...
            showSnackbar(R.string.location_permission_rationale,
                    android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(LocationOnMapActivity.this,
    ...
    public void clickNavigation() {
        if (mCurrentLocation != null) {
            if (mGoogleMap != null) {
                ...
                startIntentService();
                mGoogleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(tapLocation, Constant.ZOOM_LOCATION));
                activityLocationOnMapBinding.navigationIcon.setVisibility(View.GONE);
            }
        } else {
    ...
    public void clickConfirm() {
        ...
        if (tapLocation != null) {
            String mAddressOutputFinal = activityLocationOnMapBinding.addressSelectLocation.getText().toString().trim();

            Intent returnIntent = new Intent();
            returnIntent.putExtra("address", mAddressOutputFinal);
            returnIntent.putExtra("tapLocation", tapLocation);
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constant.SUCCESS_RESULT) {
                activityLocationOnMapBinding.addressSelectLocation.setText(mAddressOutput);
            } else {
