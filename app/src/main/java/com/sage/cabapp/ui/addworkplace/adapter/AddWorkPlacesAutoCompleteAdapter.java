package com.sage.cabapp.ui.addworkplace.adapter;
 ...
 */
public class AddWorkPlacesAutoCompleteAdapter extends RecyclerView.Adapter<AddWorkPlacesAutoCompleteAdapter.PredictionHolder> {
    private static final String TAG = "PlacesAutoAdapter";
    private ArrayList<PlaceAutocomplete> mResultList = new ArrayList<>();

    private Context mContext;
    private SourceAddressClickCallback sourceAddressClickCallback;

    public void setSourceAddressClickCallback(SourceAddressClickCallback sourceAddressClickCallback) {
        this.sourceAddressClickCallback = sourceAddressClickCallback;
    }

    public AddWorkPlacesAutoCompleteAdapter(Context context) {
        mContext = context;
    }
