 ...
 */
public class AddWorkPlaceViewModel extends BaseViewModel<AddWorkPlaceNavigator> {

    public AddWorkPlaceViewModel(SchedulerProvider schedulerProvider) {
