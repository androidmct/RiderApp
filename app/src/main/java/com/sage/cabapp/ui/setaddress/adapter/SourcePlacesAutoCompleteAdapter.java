 ...
 */
public class SourcePlacesAutoCompleteAdapter extends RecyclerView.Adapter<SourcePlacesAutoCompleteAdapter.PredictionHolder> {
    ...
    public SourcePlacesAutoCompleteAdapter(Context context) {
        mContext = context;
    }
