 ...
 */
public class ChangePaymentProfileViewModel extends BaseViewModel<ChangePaymentProfileNavigator> {
    public ChangePaymentProfileViewModel(SchedulerProvider schedulerProvider) {
