package com.sage.cabapp.ui.addhomeplace.adapter;
 ...
 */
public class AddHomePlacesAutoCompleteAdapter extends RecyclerView.Adapter<AddHomePlacesAutoCompleteAdapter.PredictionHolder> {
    ...
    public AddHomePlacesAutoCompleteAdapter(Context context) {
        mContext = context;
    }
