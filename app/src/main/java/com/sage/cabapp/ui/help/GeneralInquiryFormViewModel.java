 ...
 */
public class GeneralInquiryFormViewModel extends BaseViewModel<GeneralInquiryFormNavigator> {
    public GeneralInquiryFormViewModel(SchedulerProvider schedulerProvider) {
    ...
    void inquirySubmissionWS(Context context, String problemtype, String problemdetail, List<File> imagesList) {

        String userid = SharedData.getString(context, Constant.USERID);
        String mobile = SharedData.getString(context, Constant.PHONE_NUMBER);
        String email = SharedData.getString(context, Constant.EMAIL);
        ...
        try {
            AndroidNetworking.upload(ApiConstants.generalInquiry)
                    ...
                    .addMultipartParameter("usermobile", mobile)
                    .addMultipartParameter("useremail", email)
                    .addMultipartParameter("type", "General")
