package com.sage.cabapp.twilio.sms;
...
public class PhoneNumberVerifier extends Service {
    ...
    public static final String ACTION_VERIFICATION_STATUS_CHANGE = "com.sage.cabapp.twilio.sms.action.verification_status_change";
    ...
    private static final String ACTION_VERIFY = "com.sage.cabapp.twilio.sms.action.verify";
    private static final String ACTION_VERIFY_MESSAGE = "com.sage.cabapp.twilio.sms.action.message";
    private static final String ACTION_CANCEL = "com.sage.cabapp.twilio.sms.action.cancel";
    private static final String EXTRA_PHONE_NUMBER = "com.sage.cabapp.twilio.sms.extra.PHONE_NUMBER";
    private static final String EXTRA_MESSAGE = "com.sage.cabapp.twilio.sms.extra.MESSAGE";
    ...
    private void startVerify(String phoneNo) {
        ...
        api.request(phoneNo,
                new SMSApiHelper.RequestResponse() {
                    @Override
                    public void onResponse(boolean success) {
                        if (success) {
                            Constant.showSuccessToast("OTP sent successfully",PhoneNumberVerifier.this);
                          /*  Toast.makeText(PhoneNumberVerifier.this,
                                    getString(R.string.verifier_server_response),
                                    Toast.LENGTH_SHORT).show();*/
                        } else {
                            Constant.showErrorToast("OTP not verified",PhoneNumberVerifier.this);
                            /*Toast.makeText(PhoneNumberVerifier.this,
                    ...
                    public void onError(VolleyError error) {
                        ...
                        Constant.showErrorToast("Error in response from twilio",PhoneNumberVerifier.this);
                        stopSelf();
                    }
                });
    }
    ...
    private void verifyMessage(String smsMessage) {
        ...
        api.verify(requestPhone, smsMessage,
                new SMSApiHelper.VerifyResponse() {
                    @Override
                    public void onResponse(boolean success, String phoneNumber) {
                        ...
                        if (success && phoneNumber != null && phoneNumber.equals(requestPhone)) {
                            ...
                            Constant.showSuccessToast("Phone verification successful",PhoneNumberVerifier.this);
                            ...
                            Constant.showErrorToast("Phone number not verified",PhoneNumberVerifier.this);
                        }
                        stopSelf();
                    }
                }, new SMSApiHelper.ApiError() {
